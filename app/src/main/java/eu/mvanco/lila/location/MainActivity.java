...
package eu.mvanco.lila.location;
...
public class MainActivity extends FragmentActivity implements
    ...
    protected class GetAddressTask extends AsyncTask<Location, Void, String> {
        ...
        protected String doInBackground(Location... params) {
            ...
            try {
                ...
                // Catch network or other I/O problems.
                    ...
                    return (location.getLatitude() + "{" + location.getLongitude() + "{" + getString(R.string.IO_Exception_getFromLocation));
                ...
                // Catch incorrect latitude or longitude values
                    ...
                    //
                    return location.getLatitude() + "{" + location.getLongitude() + "{" + errorString;
                }
                ...
                if (addresses != null && addresses.size() > 0) {
                    ...
                    // Return the text
                    return location.getLatitude() + "{" + location.getLongitude() + "{" + addressText;

                // If there aren't any addresses, post a message
                } else {
                  return location.getLatitude() + "{" + location.getLongitude() + "{" + getString(R.string.no_address_found);
                }
        }
        ...
        protected void onPostExecute(String address) {
            ...
            if (address.contains("Exception")) {
	            intent.putExtra(LOCATION, "");
            }
            else {
	            
	            intent.putExtra(LOCATION, parts[2]);
